      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6">
            Hi, I'm{" "}
            <span className="gradient-text">Omar Abdelmoaty</span>
          </h1>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-muted-foreground mb-6">
            Full-Stack Developer
          </h2>
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            I build scalable, secure, and user-centric web applications using
            Angular, Node.js, and modern technologies.
          </p>
