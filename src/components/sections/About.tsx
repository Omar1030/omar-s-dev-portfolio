            ...
            <Card className="border-2 card-hover">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  I'm a passionate junior full-stack developer specializing in
                  building modern web applications with Angular and Node.js. With
                  a strong foundation in both frontend and backend technologies,
                  I create scalable, secure, and user-friendly solutions.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  My expertise includes working with MongoDB, Express, REST APIs,
                  and implementing clean code principles following MVC
                  architecture. I'm constantly learning and adapting to new
