  ...
  const experiences = [
    {
      ...
      period: "2023 - Present",
      description: [
        "Developed 15+ web applications for clients using Angular and Node.js",
        "Implemented RESTful APIs and database designs for various projects",
    ...
    },
    {
      ...
      period: "Summer 2023",
      description: [
        "Built REST APIs using Node.js and Express for enterprise applications",
    ...
    },
    {
      ...
      period: "2022 - 2023",
      description: [
        "Developed responsive websites using Angular and React",
    ...
    },
    {
      ...
      period: "2021 - 2022",
      description: [
        "Completed comprehensive courses in Angular, Node.js, and MongoDB",
        "Built personal projects to practice full-stack development",
        "Learned clean code principles and MVC architecture",
